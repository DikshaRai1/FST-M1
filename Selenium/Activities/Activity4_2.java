...
public class Activity4_2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement element= wDriver.findElement(By.xpath("//*[@id='firstName']"));
        element.sendKeys("Diksha");

        element= wDriver.findElement(By.xpath("//*[@id='lastName']"));
        element.sendKeys("Rai");

        element= wDriver.findElement(By.xpath("//*[@id='email']"));
        element.sendKeys("diksharai045@gmail.com");

        element= wDriver.findElement(By.xpath("//*[@id='number']"));
